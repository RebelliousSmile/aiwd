---
name: upgrade
description: Evaluate AI's answers and improve the next responses iteratively.
---
...
5) Verify that the new version's size is not greater than the context can handle. If it is, summarize or remove less important parts until it fits.
